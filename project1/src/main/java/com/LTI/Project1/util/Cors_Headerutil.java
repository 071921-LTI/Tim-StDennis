...
public class Cors_Headerutil {
	public static void addCorsHeader(String requestURI, HttpServletResponse rs) {
		...
		rs.addHeader("Access-Control-Allow-Headers", "Content-Type, Accept, Authorization, ifo_UserInfo, ifo_ReimRecords");
		rs.addHeader("Access-Control-Expose-Headers", "Content-Type, Accept, Authorization, ifo_UserInfo, ifo_ReimRecords");
	}
}
